![Charm logo.](charm_logo.png)

# Charm
A Python-based rhythm engine/game/chart player. Feels like an arcade cabinet, is the hope. Too many features, really!

## Where is all the code?
Charm is now developing privately for a bit while we figure everything out. Tons of Charm will be open-source again, no worries! Check us out over at https://github.com/CharmGame for any new code.
