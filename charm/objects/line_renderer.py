...
class NoteTrail(MultiLineRenderer):
    def __init__(self, note_id: Hashable, note_center: Point, time_start: Seconds, length: Seconds,
        ...
        # top of line
        points1.append((self.left_x, start_y))
        points2.append((self.right_x, start_y))
        # bottom of line
        points1.append((self.left_x, self._trail_end))
        points2.append((self.right_x, self._trail_end))
        if not self.curve:
